...
<form action="phpmailer.php" method="post">
  <div class="form-group">
    <label for="">To</label>
    <td><input type="email" value="<?php echo $email; ?>" name="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com"></td>
  </div>
  <div class="form-group">
    <label for="">Subject</label>
    <td><input type="text" class="form-control" name='subject'  id="exampleFormControlInput1" placeholder="name@example.com"></td>
  </div>
  <div class="form-group">
